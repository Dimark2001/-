...
namespace Museym
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			this.button10.Location = new System.Drawing.Point(1754, 1000);
			...
			this.label1.Text = "Ваши глаза начали привыкать к темноте. Проявились очертания комнаты. \r\nПервое, чт" +
	"о вы замечаете - надпись \"Быт и культура Манси\". ";
