...
namespace Museym
{
	partial class Form3
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Вы огляделись и увидели ЭТО!!!\r\nПеред вами стоял человек в роскошной одежде. ВЫ с" +
	"просили у него: Где мы?\r\nОн не ответил. Вы прислушались, человек не дышал.";
